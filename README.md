...
One of the requirements was to ensure the use of Ansible was visible within the project. I was not abloe to do so as I did not fully understand the use cases, especially with regards to the project. As something that is quite powerful, I hope to be able to utlise to its best in future projects/work. 
